        ...
        <Typography align={'center'} variant={'h2'}>
            ...
            <Grid container item xs spacing={3} direction="row"  justify="space-around"  alignItems="center">
                    <div className={classes.photoGridItem}> 
                        ...
                        <p><a href="mailto:alejandrod.dominguez@tec.mx" target="_blank">alejandrod.dominguez@tec.mx</a> Twitter:<a href="https://twitter.com/alejdiazd" target="_blank">@alejdiazd</a></p>
                    </div>
                    <div className={classes.photoGridItem}>
                        ...
                        <p><a href="mailto:alfredo.galvan@tec.mx" target="_blank">alfredo.galvan@tec.mx</a> Twitter:<a href="https://twitter.com/jagalvan2" target="_blank">@jagalvan2</a></p>
                    </div>
                    <div className={classes.photoGridItem}> 
                        <p className="names" align={'center'}>Juan Carlos Garfias</p>
                        <img src="images/juancarlosgarfias.png" className="img-responsive" alt="Image"/>
